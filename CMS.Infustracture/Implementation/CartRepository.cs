...
namespace CMS.Infustracture.Implementation
{
    public class CartRepository : ICartRepository
    {
        ...
        public Task<IEnumerable<Cart>> FindAllAsync(Expression<Func<Cart, bool>> expression, CancellationToken cancellationToken)
        {
        ...
        Task<bool> ICartRepository.DeleteAsync(int id, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
    }
